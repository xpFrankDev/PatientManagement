 ...
 * @author Family
 */
public class panelParametroDocumento extends javax.swing.JPanel {
    ...
    public panelParametroDocumento() {
        initComponents();
        reset();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Gestión de Tipos de Documento");
    ...
    private void editarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBtnActionPerformed
        ...
        if (fila >= 0 && !id.equals("-")) {
            ...
            valor = 1;
            for (TipoDocumento cargo : documentos) {
    ...
    private void guardarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarBtnActionPerformed
        if (validarCamposLlenos() == true) {
            ...
            if (valor == 0) {//nuevo
                ...
                if (repetido == false) {
                    int respuesta = new TipoDocumento().newDocumento(nombre);
                    if (respuesta > 0) {
                        new rojerusan.RSNotifyFade("¡¡Agregado!! ", "Tipo Documento agregado con exito!", 4, RSNotifyFade.PositionNotify.BottomRight, RSNotifyFade.TypeNotify.SUCCESS).setVisible(true);
                        limpiarCampos();
                ...
                int respuesta = new TipoDocumento().updateDocumento(id, nombre, estado);
                if (respuesta > 0) {
                    new rojerusan.RSNotifyFade("¡¡Actualizado!! ", "Tipo Documento  actualizado con exito!", 4, RSNotifyFade.PositionNotify.BottomRight, RSNotifyFade.TypeNotify.SUCCESS).setVisible(true);
                    limpiarCampos();
                    buscarValorTabla(nombre);
                } else {
    ...
    public void llenarCargos() {
        ...
        modelo.setRowCount(0);
        documentos.clear();
        documentos = (ArrayList) new TipoDocumento().Listar("").clone();
    ...
    public void llenarCargos(String estadox) {
        ...
        modelo.setRowCount(0);
        documentos.clear();
        documentos = (ArrayList) new TipoDocumento().Listar(estadox).clone();
        for (TipoDocumento cargo : documentos) {
