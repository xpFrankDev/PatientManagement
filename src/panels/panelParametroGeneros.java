 ...
 * @author Family
 */
public class panelParametroGeneros extends javax.swing.JPanel {

    ArrayList<Generos> colores = new ArrayList();
    int valor = -1;
    String estado = "Activo";
    public boolean agregar=true;
    public boolean editar=true;
    public panelParametroGeneros() {
        initComponents();
        reset();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Administración de Generos");
    ...
    private void editarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBtnActionPerformed
        ...
        if (fila >= 0 && !id.equals("-")) {
            ...
            valor = 1;
            for (Generos genero : colores) {
                if (idint == genero.getId()) {
                    idTxt.setText(genero.getId() + "");
                    nombreTxt.setText(genero.getNombre());
                    if (genero.getEstado().equalsIgnoreCase("activo")) {
                        activoRb.setSelected(true);
                    } else {
    ...
    private void guardarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarBtnActionPerformed
        if (validarCamposLlenos() == true) {
            ...
            if (valor == 0) {//nuevo
                ...
                if (repetido == false) {
                    int respuesta = new Generos().newGenero(nombre);
                    if (respuesta > 0) {
                        ...
                        ParametrosPanel.actualizarPams("genero");
                    } else {
                ...
                int respuesta = new Generos().updateGenero(id, nombre, estado);
                if (respuesta > 0) {
    ...
    public void llenarGeneros() {
        ...
        colores.clear();
        colores = (ArrayList) new Generos().Listar("").clone();
        for (Generos genero : colores) {
            modelo.addRow(new Object[]{
                genero.getId(), genero.getNombre(), genero.getEstado()
            });
        }
        if (colores.size() < 1) {
            modelo.addRow(new Object[]{
    ...
    public void llenarGeneros(String estadox) {
        ...
        modelo.setRowCount(0);
        colores.clear();
        colores = (ArrayList) new Generos().Listar(estadox).clone();
        for (Generos genero : colores) {
            if (genero.getNombre().contains(estadox)) {
                modelo.addRow(new Object[]{
                genero.getId(), genero.getNombre(), genero.getEstado()
            });
            }
