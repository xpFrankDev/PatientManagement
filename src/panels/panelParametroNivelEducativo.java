 ...
 * @author Family
 */
public class panelParametroNivelEducativo extends javax.swing.JPanel {

    ArrayList<NivelEducativo> niveles = new ArrayList();
    int valor = -1;
    String estado = "Activo";
    public boolean agregar=true;
    public boolean editar=true;
    public panelParametroNivelEducativo() {
        initComponents();
        reset();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/icons8_business_report_32px.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        jLabel2.setText("Administración de Datos de Nivel Educativo");
        ...
        buttonPane1Layout.setHorizontalGroup(
            ...
            .addGroup(buttonPane1Layout.createSequentialGroup()
                .addGroup(buttonPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(buttonPane1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(activoRb, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(bloqueadoRb, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void editarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBtnActionPerformed
        ...
        if (fila >= 0 && !id.equals("-")) {
            ...
            for (NivelEducativo nivelEducativo : niveles) {
                if (idint == nivelEducativo.getId()) {
                    idTxt.setText(nivelEducativo.getId() + "");
                    nombreTxt.setText(nivelEducativo.getNombre());
                    if (nivelEducativo.getEstado().equalsIgnoreCase("activo")) {
                        activoRb.setSelected(true);
                    } else {
    ...
    private void guardarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarBtnActionPerformed
        if (validarCamposLlenos() == true) {
            ...
            if (valor == 0) {//nuevo
                ...
                for (NivelEducativo nivelEducativo : niveles) {
                    if (nivelEducativo.getNombre().equalsIgnoreCase(nombre)) {
                        repetido = true;
                    }
                }
                if (repetido == false) {
                    int respuesta = new NivelEducativo().newNivelEducativo(nombre);
                    if (respuesta > 0) {
                        new rojerusan.RSNotifyFade("¡¡Agregado!! ", "Genero agregado con exito!", 4, RSNotifyFade.PositionNotify.BottomRight, RSNotifyFade.TypeNotify.SUCCESS).setVisible(true);
                        limpiarCampos();
                        buscarValorTabla(nombre);
                        ParametrosPanel.actualizarPams("nivelEducativo");
                    } else {
                ...
                int respuesta = new NivelEducativo().updateCargo(id, nombre, estado);
                if (respuesta > 0) {
                    new rojerusan.RSNotifyFade("¡¡Actualizado!! ", "Genero actualizado con exito!", 4, RSNotifyFade.PositionNotify.BottomRight, RSNotifyFade.TypeNotify.SUCCESS).setVisible(true);
                    limpiarCampos();
                    buscarValorTabla(nombre);
                    ParametrosPanel.actualizarPams("nivelEducativo");
                } else {
    ...
    public void llenarGeneros() {
        ...
        niveles.clear();
        niveles = (ArrayList) new NivelEducativo().Listar("").clone();
        for (NivelEducativo nivelEducativo : niveles) {
            modelo.addRow(new Object[]{
                nivelEducativo.getId(), nivelEducativo.getNombre(), nivelEducativo.getEstado()
            });
        }
        if (niveles.size() < 1) {
            modelo.addRow(new Object[]{
    ...
    public void llenarNivelEducativos(String estadox) {
        DefaultTableModel modelo = (DefaultTableModel) tabla.getModel();
        modelo.setRowCount(0);
        niveles.clear();
        niveles = (ArrayList) new NivelEducativo().Listar(estadox).clone();
        for (NivelEducativo nivelEducativo : niveles) {
            if (nivelEducativo.getNombre().contains(estadox)) {
                modelo.addRow(new Object[]{
                nivelEducativo.getId(), nivelEducativo.getNombre(), nivelEducativo.getEstado()
            });
            }
